...
<body style="white-space:nowrap">
  <div id="header">
    ...
    <div id="header_text">Hamdard Time Table Management System</div>
  </div>
  ...
  <div id="nav_bar">
    <ul class="main_menu" id="main_menu">
      ...
      <li class="limenu"><img  src="images/logo.png" alt="" position="absolute" visibility="visible"></li>
    </ul>
  </div>
  <div id="content">
    ...
    <div class="box">
      ...
      <div class="elements">
        <form method="post" action="register.php">
          ...
          <input type="text" name="email"  class ="styled email" title ="8 to 32 characters needed without spacess" placeholder="Email-ID" />
  ...
  <div id="footer">Powered by Department of Computer Sciences</a></div>
</body>
</html>
