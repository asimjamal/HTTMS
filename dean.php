...
<body style="min-width: 1348px">
  ...
  <li class="limenu"><div id="shadowhead">Manage Timetables</div></li>
  <div id="nav_bar">
  ...
  <div id="content" style="padding-top: 0">
    <div class="tableContainer">
      ...
      <div id="footer" style="position: relative"><strong>Powered by Department of Computer Sciences</strong></a></div>
    </div>
